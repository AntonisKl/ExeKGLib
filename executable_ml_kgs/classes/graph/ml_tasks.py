# Copyright (c) 2022 Copyright holder of the paper "ExeKGLib: A Python Library for Machine Learning Analytics based on Knowledge Graphs" submitted to ESWC 2023 for review.
# All rights reserved.
